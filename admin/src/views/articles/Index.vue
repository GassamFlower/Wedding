<template>
  <div>
    <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:16px">
      ...
      <el-button type="primary" style="background:#c19a50;border-color:#c19a50" @click="router.push('/articles/new')">+ 写文章</el-button>
    </div>
...
<style scoped>
/* ═══════════════════════════════════════════════
   ENHANCED ARTICLES — Design Canvas Migration
   从设计画布迁移的管理端文章页增强样式
   ═══════════════════════════════════════════════ */
