    ...
    'database.queryDocument': function (data) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_g) {
                switch (_g.label) {
                    case 0:
                        isQueryDoc = !!((_b = (_a = data.query) === null || _a === void 0 ? void 0 : _a._id) === null || _b === void 0 ? void 0 : _b.$eq);
                        queryParams = gateWayFunc.buildQueryParams(__assign({ projection: data.projection, transactionId: data.transactionId }, (isQueryDoc
                            ? {}
                            : {
                                offset: (_c = data.offset) !== null && _c !== void 0 ? _c : 0,
                                limit: (_d = data.limit) !== null && _d !== void 0 ? _d : 100,
                                order: data.order,
                        ...
                        if (isQueryDoc) {
                            url = "".concat(gateWayFunc.getUrlPrefix(data), "/collections/").concat(data.collectionName, "/documents/").concat(((_e = data.query._id) === null || _e === void 0 ? void 0 : _e.$eq) || data.query._id, "?").concat(queryParams);
                        }
                    ...
                    case 1:
                        ...
                        if (isQueryDoc && !res.code && !((_f = res.data) === null || _f === void 0 ? void 0 : _f.code)) {
